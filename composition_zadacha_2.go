// задача из учебника: Напишите программу со структурой gps для Системы Глобального Позиционирования (GPS). Данная структура должна состоять из текущей местности, места назначения и мира. - вариант решения из учебника.
package main
