// задача из учебника: Используйте метод distance из Листинга 4 и напишите программу, что определяет расстояние между каждой парой мест посадки из Таблицы 1. Какие места посадки находятся ближе всего друг к другу? Какие места дальше всего друг от друга? - вариант решения из учебника.
package main
